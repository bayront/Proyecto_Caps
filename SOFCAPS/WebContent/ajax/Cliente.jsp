...
<div class="row">
	<div id="breadcrumb" class="col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="#">Todos los clinetes</a></li>
		</ol>
	</div>
</div>
		...
		<div class="box" style="top: 0px; left: 0px; opacity: 1;">
			...
			<div class="box-content">
				...
				<div class="form-group">
					...
					<div class="col-sm-5"><input  id="celular" name="celular" type="text" class="form-control" title="Acepta solo números" onkeypress="return valida(event)"/></div>
				</div>
				<div class="form-group">
